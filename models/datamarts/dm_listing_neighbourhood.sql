...
agg as (
    select
        ...
        -- stays & revenue for active listings
...
select
    ...
    avg_price_active,
    distinct_hosts,
    case when prev_active   is null or prev_active = 0 then null else (active_listings   - prev_active  )::numeric / prev_active   end as pct_change_active_listings,
    case when prev_inactive is null or prev_inactive = 0 then null else (inactive_listings - prev_inactive)::numeric / prev_inactive end as pct_change_inactive_listings,
